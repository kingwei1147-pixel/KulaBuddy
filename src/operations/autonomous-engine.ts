...
export class AutonomousEngine {
  ...
  private async decomposeObjective(params: {
    ...
    const decomposeGoal = [
      ...
      `Break this down into 3-6 concrete, executable sub-tasks. Each sub-task should be a single clear goal that KulaBuddy can execute. Return ONLY a JSON array of { "goal": "...", "taskType": "..." }.`,
    ].join("\n");
